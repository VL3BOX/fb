<template>
    <div class="m-fb-gem" v-loading="loading">
        ...
        <el-button class="m-archive-more" :class="{ show: hasNextPage }" type="primary" :loading="loading" @click="appendPage(++page)" icon="el-icon-arrow-down" v-show="hasNextPage">加载更多</el-button>
        <el-pagination
